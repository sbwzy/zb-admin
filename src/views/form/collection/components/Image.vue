      ...
      >
        <div class="m-preview-body">
          <div class="m-preview-operations">
            <a class="u-name" :href="images[previewIndex].src" target="_blank" :title="getImageName(images[previewIndex])">
          ...
          <template v-if="imageCount > 1">
            ...
            <div class="m-switch-right" :class="{ 'u-switch-disabled': previewIndex === imageCount - 1 && !loop }" @click="onSwitchRight">
